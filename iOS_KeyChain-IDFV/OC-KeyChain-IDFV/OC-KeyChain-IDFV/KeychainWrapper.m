...
/*
 ...
 https://developer.apple.com/library/content/documentation/Security/Conceptual/CertKeyTrustProgGuide/index.html#//apple_ref/doc/uid/TP40001358
 ...
 http://www.jianshu.com/p/64340b1e38e7
...
{
    if ((self = [super init])) {
        // Set up the keychain search dictionary:（设置一个搜索字典）
        ...
        } else if (keychainErr == errSecItemNotFound) { // 在keychain中无法找到指定的item
...
- (id)initWithIdentifier: (NSString *)identifier accessGroup:(NSString *)accessGroup
{
    if (self = [super init]) {
        ...
        CFMutableDictionaryRef outDictionary = nil;
        OSStatus keychainErr = SecItemCopyMatching((__bridge CFDictionaryRef)tempQuery, (CFTypeRef *)&outDictionary);
...
#else
                [keychainData setObject:accessGroup forKey:(id)kSecAttrAccessGroup];
#endif
            }
